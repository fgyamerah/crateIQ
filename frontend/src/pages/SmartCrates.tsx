...
export default function SmartCrates() {
  ...
  useEffect(() => {
    let cancelled = false
    fetchReviewSummary(preview?.tracks.map((track) => track.track_id) ?? [])
