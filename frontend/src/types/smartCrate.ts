...
export interface SmartCrateFunnelStage { label: string; remaining: number }
export interface SmartCratePreview { criteria: SmartCrateCriteria; generated_name: string; explanation: string; warnings: string[]; track_count: number; tracks: SmartCrateTrack[]; funnel: SmartCrateFunnelStage[] }
