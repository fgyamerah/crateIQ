...
_METADATA_SOURCE_DEFINITIONS: tuple[dict[str, Any], ...] = (
    ...
    {"id": "beets", "label": "Beets", "category": "installed_tool", "requires_credentials": False, "default_enabled": True, "priority": 60, "best_for": ["Missing non-critical local-index metadata review"], "current_behavior": "implemented", "configuration_note": "Used by explicit Enrichment Review lookups and Process All's bounded provider-consensus stage. Distance-scored MusicBrainz-backed matching from beets' own matching engine."},
    {"id": "musicbrainz", "label": "MusicBrainz", "category": "external_api", "requires_credentials": False, "default_enabled": False, "priority": 40, "best_for": ["Official releases and albums"], "current_behavior": "implemented", "configuration_note": "Used by explicit Enrichment Review lookups and Process All's bounded provider-consensus stage. Rate-limited to MusicBrainz's own 1 request/second limit; results are cached locally."},
