...
_ALLOWED = frozenset({"ping", "status", "start_candidate", "stop_candidate", "inspect_child", "restore_previous", "handoff_library", "activate_registered_library"})
...
def request(operation: str, payload: dict[str, object] | None = None, *, socket_path: Path = DEFAULT_SOCKET_PATH) -> dict[str, Any]:
    ...
    try:
        ...
        raise SupervisorIPCError("supervisor_unavailable") from exc
